...
export default function Header() {
  ...
  const backdrop = useTransform(scrollY, [0, 80], ["rgba(255,255,255,0.3)", "rgba(255,255,255,0.8)"]);
  ...
  return (
    <motion.header
      ...
      style={{ height, backgroundColor: backdrop, boxShadow: shadow, scale }}
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-2 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          <motion.button
            className="text-sm text-gray-700 hover:text-black transition duration-200"
            whileTap={{ scale: 0.95 }}
          >
            Login
          </motion.button>
